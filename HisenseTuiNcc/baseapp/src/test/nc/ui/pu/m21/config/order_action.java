...
public nc.ui.pubapp.billref.dest.TransferBillViewProcessor getTransferBillViewProcessor(){
 ...
 return (nc.ui.pubapp.billref.dest.TransferBillViewProcessor)context.get("transferBillViewProcessor");
  ...
  bean.setTransferLogic(getDefaultBillDataLogic_e7a2c2());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.pubapp.billref.dest.DefaultBillDataLogic getDefaultBillDataLogic_e7a2c2(){
 if(context.get("nc.ui.pubapp.billref.dest.DefaultBillDataLogic#e7a2c2")!=null)
 return (nc.ui.pubapp.billref.dest.DefaultBillDataLogic)context.get("nc.ui.pubapp.billref.dest.DefaultBillDataLogic#e7a2c2");
  nc.ui.pubapp.billref.dest.DefaultBillDataLogic bean = new nc.ui.pubapp.billref.dest.DefaultBillDataLogic();
  context.put("nc.ui.pubapp.billref.dest.DefaultBillDataLogic#e7a2c2",bean);
  bean.setBillForm((nc.ui.pubapp.uif2app.view.PubShowUpableBillForm)findBeanInUIF2BeanFactory("billFormEditor"));
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.pubapp.billref.dest.TransferViewProcessor getTransferViewProcessor(){
 ...
 return (nc.ui.pubapp.billref.dest.TransferViewProcessor)context.get("transferViewProcessor");
  ...
  bean.setTransferLogic(getOrderTransferBillDataLogic_16eaa84());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private nc.ui.pu.m21.billref.dest.OrderTransferBillDataLogic getOrderTransferBillDataLogic_16eaa84(){
 if(context.get("nc.ui.pu.m21.billref.dest.OrderTransferBillDataLogic#16eaa84")!=null)
 return (nc.ui.pu.m21.billref.dest.OrderTransferBillDataLogic)context.get("nc.ui.pu.m21.billref.dest.OrderTransferBillDataLogic#16eaa84");
  nc.ui.pu.m21.billref.dest.OrderTransferBillDataLogic bean = new nc.ui.pu.m21.billref.dest.OrderTransferBillDataLogic();
  context.put("nc.ui.pu.m21.billref.dest.OrderTransferBillDataLogic#16eaa84",bean);
  bean.setBillForm((nc.ui.pubapp.uif2app.view.PubShowUpableBillForm)findBeanInUIF2BeanFactory("billFormEditor"));
...
public nc.ui.pu.m21.action.AddManualAction getAddManualAction(){
 ...
 return (nc.ui.pu.m21.action.AddManualAction)context.get("addManualAction");
  ...
  bean.setSourceBillName(getI18nFB_7cca13());
  bean.setModel((nc.ui.uif2.model.AbstractAppModel)findBeanInUIF2BeanFactory("manageAppModel"));
  bean.setEditor((nc.ui.uif2.editor.IBillCardPanelEditor)findBeanInUIF2BeanFactory("billFormEditor"));
...
private java.lang.String getI18nFB_7cca13(){
 if(context.get("nc.ui.uif2.I18nFB#7cca13")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#7cca13");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#7cca13",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#7cca13",product);
...
public nc.ui.pu.m21.action.AddFromSourceAction getAddFrom20Action(){
 ...
 return (nc.ui.pu.m21.action.AddFromSourceAction)context.get("addFrom20Action");
  ...
  bean.setSourceBillName(getI18nFB_b6c98c());
...
private java.lang.String getI18nFB_b6c98c(){
 if(context.get("nc.ui.uif2.I18nFB#b6c98c")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#b6c98c");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#b6c98c",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#b6c98c",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.pu.m21.action.AddFromContratAction getAddFromZ2Action(){
 ...
 return (nc.ui.pu.m21.action.AddFromContratAction)context.get("addFromZ2Action");
  ...
  bean.setSourceBillName(getI18nFB_6a1c3c());
  bean.setFlowBillType(false);
  bean.setModel((nc.ui.uif2.model.AbstractAppModel)findBeanInUIF2BeanFactory("manageAppModel"));
  bean.setEditor((nc.ui.uif2.editor.IBillCardPanelEditor)findBeanInUIF2BeanFactory("billFormEditor"));
  bean.setTransferViewProcessor(getTransferViewProcessor());
...
private java.lang.String getI18nFB_6a1c3c(){
 if(context.get("nc.ui.uif2.I18nFB#6a1c3c")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#6a1c3c");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#6a1c3c",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#6a1c3c",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.pu.m21.action.AddFromSaleOrderAction getAddFrom30Action(){
 ...
 return (nc.ui.pu.m21.action.AddFromSaleOrderAction)context.get("addFrom30Action");
  ...
  bean.setSourceBillName(getI18nFB_63cb41());
  bean.setFlowBillType(false);
  bean.setModel((nc.ui.uif2.model.AbstractAppModel)findBeanInUIF2BeanFactory("manageAppModel"));
  bean.setEditor((nc.ui.uif2.editor.IBillCardPanelEditor)findBeanInUIF2BeanFactory("billFormEditor"));
  bean.setTransferViewProcessor(getTransferViewProcessor());
...
private java.lang.String getI18nFB_63cb41(){
 if(context.get("nc.ui.uif2.I18nFB#63cb41")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#63cb41");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#63cb41",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#63cb41",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.pu.m21.action.AddFromSaleOrderCoopAction getAddFrom30CoopAction(){
 ...
 return (nc.ui.pu.m21.action.AddFromSaleOrderCoopAction)context.get("addFrom30CoopAction");
  ...
  bean.setSourceBillType("30");
  bean.setSourceBillName(getI18nFB_1b549d7());
  bean.setFlowBillType(false);
  bean.setModel((nc.ui.uif2.model.AbstractAppModel)findBeanInUIF2BeanFactory("manageAppModel"));
  bean.setEditor((nc.ui.uif2.editor.IBillCardPanelEditor)findBeanInUIF2BeanFactory("billFormEditor"));
  bean.setTransferViewProcessor(getTransferViewProcessor());
...
private java.lang.String getI18nFB_1b549d7(){
 if(context.get("nc.ui.uif2.I18nFB#1b549d7")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1b549d7");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1b549d7",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1b549d7",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.pu.m21.action.AddFromSourceAction getAddFrom49Action(){
 ...
 return (nc.ui.pu.m21.action.AddFromSourceAction)context.get("addFrom49Action");
  ...
  bean.setSourceBillName(getI18nFB_102ded3());
  bean.setFlowBillType(false);
  bean.setModel((nc.ui.uif2.model.AbstractAppModel)findBeanInUIF2BeanFactory("manageAppModel"));
  bean.setEditor((nc.ui.uif2.editor.IBillCardPanelEditor)findBeanInUIF2BeanFactory("billFormEditor"));
  bean.setTransferViewProcessor(getTransferViewProcessor());
...
private java.lang.String getI18nFB_102ded3(){
 if(context.get("nc.ui.uif2.I18nFB#102ded3")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#102ded3");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#102ded3",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#102ded3",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.pubapp.uif2app.actions.AddMenuAction getAddMenu(){
 ...
 return (nc.ui.pubapp.uif2app.actions.AddMenuAction)context.get("addMenu");
  ...
  bean.setBillType("21");
  bean.setTooltip(getI18nFB_1731f60());
...
private java.lang.String getI18nFB_1731f60(){
 if(context.get("nc.ui.uif2.I18nFB#1731f60")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1731f60");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1731f60",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1731f60",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.pu.m21.action.OrderReviseInApprovingAction getReviseAction(){
 ...
 return (nc.ui.pu.m21.action.OrderReviseInApprovingAction)context.get("reviseAction");
  ...
  bean.setModel((nc.ui.uif2.model.AbstractAppModel)findBeanInUIF2BeanFactory("manageAppModel"));
  bean.setInterceptor(getShowUpComponentInterceptor_110f30a());
  bean.setPowercheck(true);
  bean.setPermissioncode("21");
...
private nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor getShowUpComponentInterceptor_110f30a(){
 if(context.get("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#110f30a")!=null)
 return (nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor)context.get("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#110f30a");
  nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor bean = new nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor();
  context.put("nc.ui.pubapp.uif2app.actions.interceptor.ShowUpComponentInterceptor#110f30a",bean);
  bean.setShowUpComponent((nc.ui.uif2.components.IAutoShowUpComponent)findBeanInUIF2BeanFactory("billFormEditor"));
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.pu.m21.action.OrderDeleteAction getDeleteAction(){
 ...
 return (nc.ui.pu.m21.action.OrderDeleteAction)context.get("deleteAction");
  ...
  bean.setSingleBillService(getOrderDeleteService_1c42261());
  bean.setModel((nc.ui.uif2.model.AbstractAppModel)findBeanInUIF2BeanFactory("manageAppModel"));
  bean.setPowercheck(true);
  bean.setPermissioncode("21");
setBeanFacotryIfBeanFacatoryAware(bean);
...
private nc.ui.pu.m21.service.OrderDeleteService getOrderDeleteService_1c42261(){
 if(context.get("nc.ui.pu.m21.service.OrderDeleteService#1c42261")!=null)
 return (nc.ui.pu.m21.service.OrderDeleteService)context.get("nc.ui.pu.m21.service.OrderDeleteService#1c42261");
  nc.ui.pu.m21.service.OrderDeleteService bean = new nc.ui.pu.m21.service.OrderDeleteService();
  context.put("nc.ui.pu.m21.service.OrderDeleteService#1c42261",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.pubapp.uif2app.actions.pflow.SaveAndCommitScriptAction getSaveApproveAction(){
 ...
 return (nc.ui.pubapp.uif2app.actions.pflow.SaveAndCommitScriptAction)context.get("saveApproveAction");
  ...
  bean.setModel((nc.ui.pubapp.uif2app.model.BillManageModel)findBeanInUIF2BeanFactory("manageAppModel"));
  bean.setBtnName(getI18nFB_1ad22ac());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private java.lang.String getI18nFB_1ad22ac(){
 if(context.get("nc.ui.uif2.I18nFB#1ad22ac")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1ad22ac");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1ad22ac",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1ad22ac",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.pu.m21.action.RefAddRowsFromSourceAction getRefAddRowsFrom20Action(){
 ...
 return (nc.ui.pu.m21.action.RefAddRowsFromSourceAction)context.get("refAddRowsFrom20Action");
  ...
  bean.setSourceBillType("20");
  bean.setSourceBillName(getI18nFB_1bf69d6());
  bean.setFlowBillType(false);
  bean.setModel((nc.ui.uif2.model.AbstractAppModel)findBeanInUIF2BeanFactory("manageAppModel"));
  bean.setEditor((nc.ui.pubapp.uif2app.view.BillForm)findBeanInUIF2BeanFactory("billFormEditor"));
  bean.setTransferViewProcessor(getTransferViewProcessor());
...
private java.lang.String getI18nFB_1bf69d6(){
 if(context.get("nc.ui.uif2.I18nFB#1bf69d6")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1bf69d6");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1bf69d6",bean);  bean.setResDir("4001002_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1bf69d6",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
...
public nc.ui.pubapp.uif2app.actions.pflow.PFApproveStatusInfoAction getApproveStatusAction(){
 ...
 return (nc.ui.pubapp.uif2app.actions.pflow.PFApproveStatusInfoAction)context.get("approveStatusAction");
  ...
  bean.setModel((nc.ui.uif2.model.AbstractUIAppModel)findBeanInUIF2BeanFactory("manageAppModel"));
  bean.setBtnName(getI18nFB_1bd7a1e());
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private java.lang.String getI18nFB_1bd7a1e(){
 if(context.get("nc.ui.uif2.I18nFB#1bd7a1e")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#1bd7a1e");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#1bd7a1e",bean);  bean.setResDir("4001002_0");
...
invokeInitializingBean(bean);
 try {
     Object product = bean.getObject();
    context.put("nc.ui.uif2.I18nFB#1bd7a1e",product);
     return (java.lang.String)product;
}
catch(Exception e) { throw new RuntimeException(e);}}
